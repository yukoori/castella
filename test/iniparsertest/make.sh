...
echo -e $Color_Off$BGreen$os "castella iniparsertest build start!!!================"$Color_Off
if [[ $os = 'Linux' ]]
then
...
then
	...
	$MAKE;
	if [[ $? != 0 ]]; then
		echo -e $Color_Off$On_Red$BYellow'Fail to Compile "castella iniparsertest"\n'$Color_Off
		exit 1
	fi
elif [[ $1 = 'build' ]]
then
...
echo -e $Color_Off$BGreen$os "castella iniparsertest build finished!!!================"$Color_Off

...
echo -e $Color_Off$BGreen$os "castella testserver build start!!!================"$Color_Off
if [[ $os = 'Linux' ]]
then
...
then
	...
	$MAKE all;
	if [[ $? != 0 ]]; then
		echo -e $Color_Off$On_Red$BYellow'Fail to Compile "castella testserver"\n'$Color_Off
		exit 1
	fi
elif [[ $1 = 'build' ]]
then
...
echo -e $Color_Off$BGreen$os "castella testserver build finished!!!================"$Color_Off
